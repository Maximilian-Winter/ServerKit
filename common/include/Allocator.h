...
public:
    ...
    static constexpr size_type CHUNK_SIZE = 4096;  // Size of each memory chunk
    static constexpr size_type SMALL_OBJECT_THRESHOLD = 64;  // Threshold for small object optimization
    ...
    ByteVector(const ByteVector& other)
        ...
        if (size_ > SMALL_OBJECT_THRESHOLD) {
